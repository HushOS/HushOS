...
- **Split pages.** Marketing and auth pages divide into a 4/8 or 5/7 column grid with a vertical rule. The left column is a ledger of facts with a large mono headline pinned to the bottom; the right column holds the form or the copy.
