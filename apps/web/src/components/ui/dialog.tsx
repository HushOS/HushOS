    ...
    return (
        <DialogPortal>
            ...
            <DialogPrimitive.Popup
                ...
                className={cn(
                    'fixed top-1/2 left-1/2 z-50 grid max-h-[calc(100dvh-2rem)] w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-5 overflow-y-auto rounded-xl border border-border bg-popover p-5 text-sm text-popover-foreground shadow-overlay transition duration-150 ease-out-soft outline-none data-ending-style:scale-[0.98] data-ending-style:opacity-0 data-starting-style:scale-[0.98] data-starting-style:opacity-0 sm:max-w-md motion-reduce:transition-none',
                    className,
                )}
                {...props}
            >
...
/* Sits under a hairline at the foot of the card; buttons read as a row of controls, not a toolbar. */
