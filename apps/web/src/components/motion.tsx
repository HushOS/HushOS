import { AnimatePresence, LazyMotion, m, MotionConfig, type Transition } from 'motion/react';
...
/* The animation engine is its own chunk, fetched once the page is interactive. */
