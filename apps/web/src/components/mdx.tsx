...
/*
 * The one component map for every MDX document. Section headings are set
 * large with a rule above, so a long page scans; paragraphs stay in sans for
 * reading comfort, and internal links route client-side. Documents may also import their own components.
 */
export const mdxComponents: MDXComponents = {
    ...
    h2: (props) => (
        <h2
            className="mt-12 border-t pt-6 text-2xl font-medium tracking-tight text-balance first:mt-0 first:border-t-0 first:pt-0 sm:text-[1.75rem]"
            {...props}
        />
    ),
    h3: (props) => <h3 className="mt-8 text-lg font-medium tracking-tight" {...props} />,
    p: (props) => <p className="mt-4 leading-relaxed" {...props} />,
    img: (props) => <img className="mt-6 block w-full border" loading="lazy" {...props} />,
    ul: (props) => (
    ...
    return (
        <aside className="mt-8 border">
            ...
            <div className="border-t p-3">
                ...
                >
                    {hasSession ? 'Open Drive' : 'Get started'}{' '}
