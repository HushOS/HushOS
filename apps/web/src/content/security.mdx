...
Folder and file keys will hang off the workspace key, not off your account key. That is what keeps rotation cheap: replacing your account key rewraps one grant per workspace you belong to, and nothing beneath it moves.
...
Drive will apply the same shape to files: folder and file keys created on your device and wrapped under the workspace key, content encrypted before it leaves, and envelopes bound to their owner and version. When it ships, this page will document the folder and file key hierarchy in the same detail. Until then, treat anything not on this page as not implemented.
