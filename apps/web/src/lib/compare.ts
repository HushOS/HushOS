...
const HUSHOS = {
    ...
    apps: 'Web app that installs on any phone or computer. Desktop and mobile apps coming very soon.',
    company:
...
export const comparisons: Comparison[] = [
    ...
    },
    {
        ...
        theirs: [
            'You want native apps today, with folder sync on your computer. Proton has years of them; ours are coming very soon.',
