 ...
 * text as a string, images as a blob URL. Memory only, bounded, and dropped
 * on lock together with every other decrypted thing. Media and PDF stream by
 * range and are not kept.
 */
