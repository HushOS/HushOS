...
/*
 * Screenshots are taken at two device pixels per CSS pixel (see
 * e2e/screenshots.spec.ts) and quantised to a palette: a screenshot of flat
 * UI loses nothing that way and comes out a fraction of the size, small
 * enough for the manifest and the marketing pages alike.
 */
const screenshots = resolve(publicDirectory, 'screenshots');
